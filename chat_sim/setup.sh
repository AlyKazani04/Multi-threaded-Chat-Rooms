...
# NOTE: This script is designed for Ubuntu 24.03 on VMBox. 
#       If you're using a different Linux distribution, 
#       you may need to adjust the package manager commands 
#       and package names accordingly.
# I also have ran this file and it works fine on my VMBox Ubuntu.
...
echo ""
echo "Next steps:"
echo "  cd $(dirname "$SCRIPT_DIR/chat_sim")/chat_sim"
echo "  make"
